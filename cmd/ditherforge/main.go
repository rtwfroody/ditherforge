...
type Args struct {
	...
	Dither                          string   `arg:"--dither" default:"riemersma" help:"Dithering mode: riemersma, blue-noise, dizzy-corrected, floyd-steinberg, none (also accepted: dizzy-2hop, dizzy-recover)"`
