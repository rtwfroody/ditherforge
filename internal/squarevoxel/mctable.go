...
// mcEdges defines the 12 edges of a cube by vertex pairs.
...
// mcTriTable is the marching cubes triangle table (256 cases).
// Each entry is a list of edge indices in triples forming output triangles.
// Derived from Paul Bourke's / Cory Bloyd's classic MC table.
var mcTriTable = [256][]int{
	/*   0 */ {},
	/*   1 */ {0, 8, 3},
	/*   2 */ {0, 1, 9},
	/*   3 */ {1, 8, 3, 9, 8, 1},
