...
func RunCached(ctx context.Context, cache *StageCache, opts Options, cb *Callbacks) (*ProcessResult, error) {
	...
	switch opts.Dither {
	case "none", "dizzy-corrected", "dizzy-prop", "dizzy-rprop", "floyd-steinberg", "auto":
	default:
		return nil, fmt.Errorf("invalid --dither %q: must be none, dizzy-corrected, dizzy-prop, dizzy-rprop, floyd-steinberg, or auto", opts.Dither)
	}
