...
func init() {
	stageDefs = [numStages]StageDef{
		...
		{
			ID:           StageColorAdjust,
			Name:         "Adjusting colors",
			Subdir:       "coloradjust",
			Deps:         []StageID{StageVoxelize},
			Alloc:        func() any { return &colorAdjustOutput{} },
			Description:  describeColorAdjust,
			HashSettings: hashColorAdjustSettings,
			Run:          (*pipelineRun).runColorAdjust,
		},
		{
			ID:           StageColorWarp,
			Name:         "Warping colors",
			Subdir:       "colorwarp",
			Deps:         []StageID{StageColorAdjust},
			Alloc:        func() any { return &colorWarpOutput{} },
			Description:  describeColorWarp,
			HashSettings: hashColorWarpSettings,
			Run:          (*pipelineRun).runColorWarp,
		},
		{
			ID:           StagePalette,
			Name:         "Building palette",
			Subdir:       "palette",
			Deps:         []StageID{StageColorWarp},
